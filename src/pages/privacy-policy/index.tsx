  ...
  return (
    <div className="max-w-7xl w-full px-6 py-10 mx-auto flex flex-col gap-4">
      ...
      <p>
        ...
        shared and/or collect in Digital Dialogue. This policy is not applicable
      ...
      <p>
        Digital Dialogue follows a standard procedure of using log files. These
        files log visitors when they visit websites. All hosting companies do
        this and a part of hosting services&lsquo; analytics. The information
        ...
        tracking users&lsquo; movement on the website, and gathering demographic
        information.
      </p>
      ...
      <p>
        Like any other website, Digital Dialogue uses &ldquo;cookies&ldquo;.
        These cookies are used to store information including visitors&lsquo;
      ...
      <p>
        ...
        advertising partners of Digital Dialogue.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Digital Dialogue, which are sent
      ...
      <p>
        Note that Digital Dialogue has no access to or control over these
      ...
      <p>
        Digital Dialogue&lsquo;s Privacy Policy does not apply to other
      ...
      <p>
        Digital Dialogue does not knowingly collect any Personal Identifiable
