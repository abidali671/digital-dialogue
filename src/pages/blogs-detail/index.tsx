...
const BlogDetail = () => {
    ...
    return (
        <React.Fragment>
            ...
            <ContentContainer>
                {/* Card start*/}
                <div className="p-5 gap-3 flex w-11/12  md:w-8/12 flex-col text-left items-start border border-gray-200 shadow-gray-200 shadow-sm border-t-0 bg-white relative bottom-32  mx-auto ">
                ...
                {/* Card end*/}
                <main className='grid h-[100%] mx-auto md:grid-cols-[200px_1fr]   grid-cols-[1fr] w-11/12  md:w-8/12' >
                    {/* Aside column start*/}
