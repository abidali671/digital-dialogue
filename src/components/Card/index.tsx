    ...
    return (
        <div className=" grow flex flex-col max-w-xs ">
            <div className="relative  h-[240px] w-full object-contain">
                <Image src='https://media.cnn.com/api/v1/images/stellar/prod/allbirds-sneakers-review-wool-runnerjpg.jpg?q=h_1090,w_1938,x_0,y_0' alt="shoes" fill />
            ...
            <div className="p-4 gap-2 flex flex-col text-left items-start  border border-gray-200 shadow-gray-200 shadow-md border-t-0 bg-white relative w-[95%] top-[-20px] ">
                ...
                <Link href="#">
                    <h5 className=" text-[28px] font-bold tracking-tight text-gray-900 leading-[32px] dark:text-white font-PT">Top 10 beautiful Place in Bangladesh</h5>
                </Link>
                ...
                <Link href="#" className="pt-2 inline-flex items-center  text-sm font-medium text-center text-black ">
                    Read more
