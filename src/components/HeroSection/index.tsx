...
const Hero = () => {
  ...
  return (
    <div className="flex relative justify-center sm:h-[calc(100vh_-_64px)] h-[70vh] overflow-hidden">
      <div className="w-[40%] relative md: bg-neutral-50 bg-none ">
      ...
      <div className="flex h-full items-center">
        <div key={content?.id} className="bg-white z-0 absolute  md:w-[46%]  w-[100%]  sm:text-left text-center sm:items-start  items-center left-0 md:left-24  p-6 flex flex-col gap-2">
          ...
          <button onClick={() => console.log(content?.id)} className="p-2 bg-orange-500 rounded-sm w-[100px]  lg:w-[130px] text-white">
            Read More
          </button>
        </div>
      </div>

      <div className="flex  absolute lg:bottom-6 bottom-2 sm:left-24 items-center gap-3">
        {/* content slider */}
